...
console.log(`📦 ${chunks.length} chunks to apply (STAGING - Phase 1: auth.* functions)\n`);

const projectId = 'qlvkgniqcoisbnwwjfte'; // STAGING
...
(async () => {
  ...
  console.log(`\n${'='.repeat(60)}`);
  console.log(`✅ Success: ${success}/${chunks.length} (STAGING Phase 1)`);
