/**
 * Apply pending migrations to TST via Supabase Management API
 *
 * This script:
 ...
 *
 * Usage: pnpm dlx tsx scripts/apply-migrations-tst.ts
 *
 * Required env vars:
 * - SUPABASE_TST_PROJECT_ID
...
const PROJECT_ID = process.env.SUPABASE_TST_PROJECT_ID;
const ACCESS_TOKEN = process.env.SUPABASE_ACCESS_TOKEN;

if (!PROJECT_ID || !ACCESS_TOKEN) {
  console.error('❌ Missing required environment variables:');
  console.error('  - SUPABASE_TST_PROJECT_ID');
...
async function main() {
  console.log('');
  console.log('================================================');
  console.log('🔄 Applying TST Migrations');
  console.log('================================================');
  console.log('');
