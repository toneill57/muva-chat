/**
 * PRD Health Check Script
 *
 * Verifies that the production deployment is healthy by:
...
const PRD_URL = process.env.PRD_URL || 'https://muva.chat'
...
async function main() {
  console.log('================================================')
  console.log('🏥 PRD Health Check')
  console.log('================================================')
  console.log(`🌐 URL: ${PRD_URL}`)
  ...
  try {
    ...
    console.log('\n================================================')
    console.log('✅ PRD HEALTH CHECK PASSED')
    console.log('================================================\n')
    ...
    console.log('\n================================================')
    console.log('❌ PRD HEALTH CHECK FAILED')
    console.log('================================================')
