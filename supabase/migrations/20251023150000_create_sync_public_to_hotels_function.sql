-- Migration: Create sync_accommodation_units_public_to_hotels RPC function
-- Date: 2025-10-23
-- Purpose: Sync consolidated accommodation units from accommodation_units_public
--          to hotels.accommodation_units for operational use
...
'Syncs consolidated accommodation units from accommodation_units_public to hotels.accommodation_units. Returns counts of created, updated, and failed records.';

-- Grant execute permission
GRANT EXECUTE ON FUNCTION public.sync_accommodation_units_public_to_hotels(UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION public.sync_accommodation_units_public_to_hotels(UUID) TO service_role;
