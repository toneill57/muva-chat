-- FIX FINAL: Crear get_sire_guest_data con nombre de tabla CORRECTO
-- PROBLEMA: La función buscaba "divipola_cities" pero la tabla se llama "sire_cities"
...
BEGIN
  ...
  SELECT
    ...
    gr.movement_date,
    gr.origin_city_code,
    COALESCE(scit_orig.name, sc_orig.name_es) AS origin_city_name,  -- ✅ sire_cities
    gr.destination_city_code,
    COALESCE(scit_dest.name, sc_dest.name_es) AS destination_city_name,  -- ✅ sire_cities
    gr.birth_date
