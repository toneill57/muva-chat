...
export default async function WithMePage() {
  ...
  console.log('[with-me/page.tsx] hostname:', hostname, 'subdomain:', subdomain)
  ...
  console.log('[with-me/page.tsx] Fetching tenant for subdomain:', subdomain)
  const tenant = await getTenantBySubdomain(subdomain)
  console.log('[with-me/page.tsx] Tenant fetch result:', tenant ? `Found: ${tenant.business_name || tenant.nombre_comercial}` : 'null')

  // Tenant not found → 404
  if (!tenant) {
    console.error(`[with-me/page.tsx] Tenant not found for subdomain: ${subdomain}`)
    notFound()
  }
