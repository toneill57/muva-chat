...
- **Claves de habitaciones individuales** (cualquiera abre la puerta principal):
  - Jammin': `4268`
  - Natural Mystic: `3971`
  - Dreamland: `2684`
  - Kaya: `1397`
...
**A:**
1. Al entrar al edificio, sube al último piso
2. Tendrás acceso a todas las habitaciones del apartamento Simmer Highs
...
## Configuración del Apartamento {#configuracion}

### Distribución
**Q: ¿Cómo está distribuido el apartamento Simmer Highs?**
**A:**
- **Ubicación**: Último piso del edificio
- **Capacidad**: Hasta 8 personas
- **Habitaciones**: 4 habitaciones privadas con baño cada una
  - Jammin'
  - Natural Mystic
  - Dreamland
  - Kaya
- **Áreas comunes**: Sala, cocina compartida
- **Ideal para**: Grupos grandes, familias extendidas, retiros
...
**A:**
- Cada habitación tiene su propio aire acondicionado independiente
- **Control remoto**: Con pantalla digital en cada habitación
- **Encendido**: Botón POWER
- **Temperatura recomendada**: 23-24°C
- **Modos**: COOL (enfriamiento), DRY (deshumidificación), FAN (ventilador)
...
**A:**
- **Ubicación**: Área común del apartamento
- **Estufa**: Disponible para cocinar
- **Refrigerador**: Grande, espacio para todo el grupo
- **Microondas**: Para calentar alimentos
- **Cafetera**: Eléctrica de goteo
- **Utensilios completos**: Ollas, sartenes, platos, cubiertos, vasos para 8 personas
...
### Áreas Comunes
**Q: ¿Qué áreas de entretenimiento hay?**
**A:**
- **Sala común**: Área de convivencia para el grupo
- **Smart TV**: En área común (si disponible)
- **TVs individuales**: Cada habitación tiene su propia TV
...
- **Ubicación**: Cada habitación tiene su propia caja fuerte
- **Uso**: Configurable por cada huésped

### Cerradura Principal
- **Tipo**: Cerradura electrónica con código
- **Códigos**: Cualquiera de las 5 claves abre la puerta principal
- **Cierre manual**: Girar perilla desde adentro

---

## Baños Privados {#banos}

### 4 Baños Completos
**Q: ¿Cada habitación tiene baño privado?**
**A:**
- **Sí**: Cada una de las 4 habitaciones tiene baño privado completo
- **Sistema de ducha**: Agua caliente instantánea
- **Amenities**: Shampoo, jabón, toallas
- **Privacidad total**: Sin necesidad de compartir baños
...
- **Limpieza diaria**: Incluida para áreas comunes y habitaciones
- **Horario**: 10am-2pm
- **Cartel "No Molestar"**: Colgar en puerta principal si el grupo prefiere privacidad
- **Toallas**: Dejar en piso de cada habitación para cambio
...
- **Detector de humo**: En áreas principales
...
- Puedes imprimir estas instrucciones o enviarlas a tu grupo

**Playa y Arena**:
- Usa la trampa de arena frente a las escaleras
- No subas con los pies mojados - sécate bien
...
- Mantén el orden en áreas comunes y habitaciones
...
**Acceso**:
- Link: https://simmerdown.house/instrucciones/apartamento-simmer-highs/
- Clave: `8613`
...
## Tips Específicos Simmer Highs {#tips-especificos}

### Características del Apartamento
- **Tipo**: Apartamento completo - 4 habitaciones con baño privado cada una
- **Ubicación**: Último piso del edificio (mejores vistas)
- **Capacidad**: Hasta 8 personas cómodamente
- **Ideal para**: Grupos grandes, familias, retiros, celebraciones

### Ventajas para Grupos
- **Privacidad**: Cada pareja/persona tiene su habitación y baño
- **Convivencia**: Áreas comunes para compartir
- **Cocina completa**: Preparar comidas para todo el grupo
- **Económico**: Mejor precio por persona que habitaciones separadas

### Servicios Adicionales
- **Desayuno**: Área común planta baja (7-10am) - adicional
- **Cocina de tu apartamento**: Privada para el grupo
...
**Claves** (cualquiera abre la puerta principal):
...
- 📱 Guía completa: https://simmerdown.house/instrucciones/apartamento-simmer-highs/ (clave: 8613)
